...
const TelegramUnpinParams = Type.Object({
  telegram_message_id: Type.Optional(
    Type.Number({
      description:
        'The Telegram message ID to unpin. If omitted, unpins all messages in the chat.',
    }),
  ),
})
