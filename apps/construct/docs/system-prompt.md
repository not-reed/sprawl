---
title: System Prompt
description: Static system prompt and dynamic context preamble
---
...
Uses `Date.toLocaleString()` with the configured timezone:

```
[Current time: 3:15 PM | Monday March 24 2026 | America/New_York | telegram]
```
