...
beforeEach(async () => {
  ...
  db = result.db;
  await m001.up(db as Kysely<any>);
  await m002.up(db as Kysely<any>);
  await m004.up(db as Kysely<any>);
  await m005.up(db as Kysely<any>);
  await m006.up(db as Kysely<any>);
  await m007.up(db as Kysely<any>);
});
