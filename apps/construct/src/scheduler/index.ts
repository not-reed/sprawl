...
export function registerJob(db: Kysely<Database>, bot: Bot, schedule: Schedule, timezone: string) {
...
async function fireSchedule(db: Kysely<Database>, bot: Bot, schedule: Schedule) {
  await fireAgentSchedule(db, bot, schedule);
}

async function fireAgentSchedule(db: Kysely<Database>, bot: Bot, schedule: Schedule) {
