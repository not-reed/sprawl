...
export const api = {
  // Campaigns
  listCampaigns: () =>
    fetchJson<{ campaigns: import('./types.js').Campaign[] }>('/campaigns'),

  getCampaign: (id: string) =>
    fetchJson<import('./types.js').CampaignDetail>(`/campaigns/${id}`),
  ...
  getCharacters: () =>
    fetchJson<{ characters: string[] }>('/settings/characters'),
}
