...
*Last updated: 2026-02-25 -- Initial documentation*
...
- [Deployment Guide](./deployment.md) -- Docker and systemd deployment procedures
- [Environment Configuration](./environment.md) -- Environment variables and .env setup
- [Extension System](./../features/extensions.md) -- Extension loading, skills, dynamic tools
- [Tool System](./../features/tools.md) -- Self-modification tools (self_read, self_edit, self_deploy)
- [Telegram Integration](./../features/telegram.md) -- Bot setup and message handling
