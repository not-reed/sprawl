...
- [Tool System](./tools.md) -- How packs and tools work in general
- [Agent System](./agent.md) -- How skills and dynamic tools are used during message processing
- [System Prompt](./system-prompt.md) -- How identity files are injected
- [Environment Configuration](./../guides/environment.md) -- EXTENSIONS_DIR and EXT_* variables
